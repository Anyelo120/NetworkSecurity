...
public class Config {
		...
		if (!configFile.exists()) {
		    try {
		        ...
		        try (FileWriter writer = new FileWriter(configFile)) {
		            ...
		            writer.write("bot.dailyReportChannelId=\n");
		            writer.write("api.token=\n");
		            writer.write("api.port=8080\n");
		            writer.write("bot.dailyReportTime=20:00\n");
		            writer.write("bot.dailyReportEnabled=true\n");
		            writer.write("bot.serverName=Mi Servidor\n");
		            writer.write("bot.logWebhookUrl=\n");
		        }
		    } catch (IOException e) {
	...
	public static String getLogWebhookUrl() {
	    return props.getProperty("bot.logWebhookUrl");
	}

	public static String getDailyReportChannelId() {
		return props.getProperty("bot.dailyReportChannelId");
	}

	public static String getDailyReportTime() {
		return props.getProperty("bot.dailyReportTime", "20:00");
	}

	public static boolean isDailyReportEnabled() {
		return Boolean.parseBoolean(props.getProperty("bot.dailyReportEnabled", "true"));
	}

	public static String getServerName() {
		return props.getProperty("bot.serverName", "Mi Servidor");
	}
